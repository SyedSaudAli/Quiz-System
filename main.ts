...
let questions_1 = await inquirer.prompt([
  {
    name: "questions1",
    type: "list",
    message: chalk.bold.bgBlackBright(
      "\tQ-1.TypeScript was born in which year?"
    ),
    choices: [
      "1 October 2012",
      "20 January 2002",
...
let questions_2 = await inquirer.prompt([
  {
    ...
    type: "list",
    message: chalk.bold.bgBlackBright(
      "\tQ-2.What are the three main 'simple types' in TypeScript?"
    ),
    choices: [
...
let questions_3 = await inquirer.prompt([
  {
    ...
    type: "list",
    message: chalk.bold.bgBlackBright(
      "\tQ-3.What type of assignment is this variable, `const fullName: string = 'Syed Saud Ali';`?"
    ),
...
let questions_4 = await inquirer.prompt([
  {
    ...
    type: "list",
    message: chalk.bold.bgBlackBright(
      "\tQ-4.True or False: TypeScript can always correctly infer a variables type."
    ),
    choices: ["False", "True"],
  },
]);
...
let questions_5 = await inquirer.prompt([
  {
    ...
    type: "list",
    message: chalk.bold.bgBlackBright(
      "\tQ-5.What is the inherited type for the variable example in `const example = ['Saud']`?"
    ),
...
let questions_7 = await inquirer.prompt([
  {
    ...
    type: "list",
    message: chalk.bold.bgBlackBright(
      "\tQ-7._____ is a return type for when nothing is returned."
    ),
...
let questions_8 = await inquirer.prompt([
  {
    ...
    type: "list",
    message: chalk.bold.bgBlackBright(
      "\tQ-8.True or False: TypeScript will always correctly infer the type of an array."
    ),
    choices: ["True", "False"],
  },
]);
...
let questions_9 = await inquirer.prompt([
  {
    ...
    type: "list",
    message: chalk.bold.bgBlackBright(
      "\tQ-9.What is the type of the parameter: `function ex(param1?: string){}`?"
    ),
...
let questions_10 = await inquirer.prompt([
  {
    ...
    type: "list",
    message: chalk.bold.bgBlackBright(
      "\tQ-10.which typeScript is used to represent a collection of values of the same type?"
    ),
...
console.log(
  chalk.bold.greenBright("Result of the quiz:"),
  `${chalk.cyanBright.underline(score)}`,
  "/",
  chalk.bold.redBright.underline("100")
);
